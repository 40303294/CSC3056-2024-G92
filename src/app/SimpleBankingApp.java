...
public class SimpleBankingApp {
	...
	public static void loadAccountData()  {
		...
		Account anAccount;
		try {
			anAccount = new Account("5495-1234", "mike", "Standard", LocalDateTime.of(2020,8,20,0,0));
			accounts.add(anAccount); 
			
			anAccount = new Account("5495-1239", "mike", "Standard", LocalDateTime.of(2020,8,20,0,0));
			accounts.add(anAccount);

			anAccount = new Account("5495-1291", "mike", "Saving", LocalDateTime.of(2019,7,21,0,0));
			accounts.add(anAccount);

			anAccount = new Account("5495-6789", "David.McDonald@gmail.com", "Saving", LocalDateTime.of(2019,8,20,0,0));
			accounts.add(anAccount);
	...
	public static double getBalance(String account_number) {
		// TODO
		// ---- Notes / Breakdown of Javadoc above ----
		// want to find out which transactions go with which account
		// want to step through each transanction and add them to a static variable
		// balance should be a double so that it can display an accurate format for money
		
		
		// Initialise balance as 0.0
		Double balance = 0.0;
		
		// For loop through the transactions on each account_number.
		...
		// Return the balance so that in the .toString() function we can display it.
		return balance;
	}
