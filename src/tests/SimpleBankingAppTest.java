...
public class SimpleBankingAppTest {
	...
	public static void testWithdrawals() {
		...
		if (balanceBefore + WithdrawAmount == balanceAfter)
			System.out.println(TestUtils.TEXT_COLOR_GREEN + "testWithdraws: TC1 passed"+ TestUtils.TEXT_COLOR_RESET);
		else {
			System.out.println(TestUtils.TEXT_COLOR_RED + "testWithdraws: TC1 FAILED XXX: balanceBefore + WithdrawAmount != balanceAfter");
